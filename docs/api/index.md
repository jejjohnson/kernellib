...
| [Spectral](spectral.md) | `AbstractStationaryKernel.spectral_density` / `sample_frequencies`, `AbstractFeatureMap`, `RandomFourierFeatures`, `OrthogonalRandomFeatures`, `FastFoodFeatures`, `NystromFeatures`, `draw_rff_cosine_basis`, `evaluate_rff_cosine_paths` |
| [Regression](regression.md) | `falkon_preconditioner`, `falkon_solve`, `falkon_predict`, `FalkonPreconditioner`, `eigenpro_preconditioner`, `eigenpro_step_size`, `eigenpro_correction`, `EigenProPreconditioner` |
