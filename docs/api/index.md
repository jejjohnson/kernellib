...
| [Decomposition](decomposition.md) | `KernelPCA`, `nearest_neighbors`, `KNNGraph`, `adjacency_matrix`, `graph_laplacian`, graph kernels, `LaplacianEigenmaps`, `SchrodingerEigenmaps`, `LocalityPreservingProjections`, potentials |
